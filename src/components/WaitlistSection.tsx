...
const COUNTRY_CODES = [
  { code: "+213", country: "🇩🇿", label: "DZ" },
  { code: "+54", country: "🇦🇷", label: "AR" },
  { code: "+61", country: "🇦🇺", label: "AU" },
  { code: "+43", country: "🇦🇹", label: "AT" },
  { code: "+32", country: "🇧🇪", label: "BE" },
  { code: "+55", country: "🇧🇷", label: "BR" },
  { code: "+359", country: "🇧🇬", label: "BG" },
  { code: "+1", country: "🇨🇦", label: "CA" },
  { code: "+56", country: "🇨🇱", label: "CL" },
  { code: "+86", country: "🇨🇳", label: "CN" },
  { code: "+57", country: "🇨🇴", label: "CO" },
  { code: "+385", country: "🇭🇷", label: "HR" },
  { code: "+420", country: "🇨🇿", label: "CZ" },
  { code: "+45", country: "🇩🇰", label: "DK" },
  { code: "+20", country: "🇪🇬", label: "EG" },
  { code: "+372", country: "🇪🇪", label: "EE" },
  { code: "+358", country: "🇫🇮", label: "FI" },
  { code: "+33", country: "🇫🇷", label: "FR" },
  { code: "+49", country: "🇩🇪", label: "DE" },
  { code: "+30", country: "🇬🇷", label: "GR" },
  { code: "+852", country: "🇭🇰", label: "HK" },
  { code: "+36", country: "🇭🇺", label: "HU" },
  { code: "+91", country: "🇮🇳", label: "IN" },
  { code: "+62", country: "🇮🇩", label: "ID" },
  { code: "+98", country: "🇮🇷", label: "IR" },
  { code: "+353", country: "🇮🇪", label: "IE" },
  { code: "+972", country: "🇮🇱", label: "IL" },
  { code: "+39", country: "🇮🇹", label: "IT" },
  { code: "+81", country: "🇯🇵", label: "JP" },
  { code: "+962", country: "🇯🇴", label: "JO" },
  { code: "+254", country: "🇰🇪", label: "KE" },
  { code: "+961", country: "🇱🇧", label: "LB" },
  { code: "+371", country: "🇱🇻", label: "LV" },
  { code: "+370", country: "🇱🇹", label: "LT" },
  { code: "+352", country: "🇱🇺", label: "LU" },
  { code: "+60", country: "🇲🇾", label: "MY" },
  { code: "+356", country: "🇲🇹", label: "MT" },
  { code: "+52", country: "🇲🇽", label: "MX" },
  { code: "+212", country: "🇲🇦", label: "MA" },
  { code: "+31", country: "🇳🇱", label: "NL" },
  { code: "+64", country: "🇳🇿", label: "NZ" },
  { code: "+234", country: "🇳🇬", label: "NG" },
  { code: "+47", country: "🇳🇴", label: "NO" },
  { code: "+92", country: "🇵🇰", label: "PK" },
  { code: "+51", country: "🇵🇪", label: "PE" },
  { code: "+63", country: "🇵🇭", label: "PH" },
  { code: "+48", country: "🇵🇱", label: "PL" },
  { code: "+351", country: "🇵🇹", label: "PT" },
  { code: "+974", country: "🇶🇦", label: "QA" },
  { code: "+40", country: "🇷🇴", label: "RO" },
  { code: "+7", country: "🇷🇺", label: "RU" },
  { code: "+966", country: "🇸🇦", label: "SA" },
  { code: "+381", country: "🇷🇸", label: "RS" },
  { code: "+65", country: "🇸🇬", label: "SG" },
  { code: "+421", country: "🇸🇰", label: "SK" },
  { code: "+386", country: "🇸🇮", label: "SI" },
  { code: "+27", country: "🇿🇦", label: "ZA" },
  { code: "+82", country: "🇰🇷", label: "KR" },
  { code: "+34", country: "🇪🇸", label: "ES" },
  { code: "+46", country: "🇸🇪", label: "SE" },
  { code: "+41", country: "🇨🇭", label: "CH" },
  { code: "+886", country: "🇹🇼", label: "TW" },
  { code: "+66", country: "🇹🇭", label: "TH" },
  { code: "+216", country: "🇹🇳", label: "TN" },
  { code: "+90", country: "🇹🇷", label: "TR" },
  { code: "+380", country: "🇺🇦", label: "UA" },
  { code: "+971", country: "🇦🇪", label: "AE" },
  { code: "+44", country: "🇬🇧", label: "UK" },
  { code: "+1", country: "🇺🇸", label: "US" },
  { code: "+58", country: "🇻🇪", label: "VE" },
  { code: "+84", country: "🇻🇳", label: "VN" },
].sort((a, b) => a.label.localeCompare(b.label));

// Min/max local digits per country code (only enforced when a rule exists)
