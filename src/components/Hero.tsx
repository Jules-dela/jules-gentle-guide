...
const AnimatedSlogan = () => {
  ...
  return <motion.p className="text-[16px] md:text-[20px] font-normal text-white max-w-[600px] mb-8 md:mb-10" variants={container} initial="hidden" animate="visible">
      {words.map((word, index) => <motion.span key={index} variants={wordAnimation} className="inline-block mr-[0.35em]">
          {word}
        </motion.span>)}
    </motion.p>;
};
export const Hero = () => {
  ...
  return <AuroraBackground className="flex items-center justify-center">
      ...
      <div className="relative z-10 px-5 md:px-20 w-full flex flex-col items-center text-center">
        {/* Headline */}
        <h1 className="text-[32px] sm:text-[42px] md:text-[60px] font-semibold text-white leading-[1.15] tracking-[-0.02em] max-w-[900px] mb-4 md:mb-6 drop-shadow-lg">Your perfect home in Lausanne.</h1>
