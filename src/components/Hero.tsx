      ...
      <div className="relative z-10 px-5 md:px-20 w-full flex flex-col items-center text-center">
        ...
        <div className="flex justify-center mb-5">
          <Button
            ...
            variant="outline"
            className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-navy font-medium text-[14px] md:text-[16px] px-8 md:px-10 py-3 md:py-4 h-auto rounded-lg backdrop-blur-sm"
          >
            Find my home
          </Button>
        </div>
