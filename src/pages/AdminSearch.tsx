      ...
      <div className="max-w-4xl mx-auto py-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1.5">
            ...
            <input
              className={inputClass}
              placeholder="Ex : Lausanne, Genève Centre…"
              value={form.area}
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              onChange={(e) => set("moving_date", e.target.value)}
            />
          </div>
          ...
          {[
            {
              key: "furnished",
              label: "Meublé",
              d: "M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2z M8 21v-2 M16 21v-2",
            },
            {
              key: "near_transport",
              label: "Proche transports",
              d: "M8 6v6 M15 6v6 M2 12h19.6 M5 18a2 2 0 100 4 2 2 0 000-4z M19 18a2 2 0 100 4 2 2 0 000-4z",
            },
          ].map(({ key, label, d }) => (
            <button
              key={key}
        ...
        {loading && (
          <p className="text-center text-sm text-muted-foreground animate-pulse">
            Exploration des portails immobiliers…
          </p>
        )}
          ...
          <div ref={resultsRef} className="space-y-6 pt-4">
              ...
              <div key={i} className="border border-border rounded-lg overflow-hidden flex flex-col md:flex-row">
                <div className="flex-1 p-5 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[l.surface, l.rooms, l.floor, ...(l.highlights || [])]
                      .filter(Boolean)
                      .map((tag, j) => (
            ...
            {results.analysis && (
              <div className="p-5 bg-muted rounded-lg text-sm text-muted-foreground leading-relaxed italic">
                <span className="text-2xl text-primary font-serif not-italic leading-none mr-1">
                  "
                </span>
                {results.analysis}
              </div>
